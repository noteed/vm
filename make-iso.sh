...
# set late command
late_command="cp /cdrom/provision.sh /target/usr/bin/ ; cp -a /cdrom/etc-tinc /target/etc/tinc ; cp /cdrom/setup-docker-tinc.sh /target/usr/bin/ ; in-target /usr/bin/provision.sh ; rm /target/usr/bin/provision.sh"
